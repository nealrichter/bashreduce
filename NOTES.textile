...
* "br":http://github.com/jweslley/bashreduce/blob/master/br somewhere handy in your path
...
<pre>br -h "host1 host2 host3"</pre>
...
There are several versions of netcat.  Ubuntu/Debian has two variants: "openbsd" and "traditional".  br just works when using netcat traditional.
